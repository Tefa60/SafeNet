    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnalysisTypes", x => x.TypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportedUrls", x => x.UrlId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskWeight = table.Column<byte>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScamPatterns", x => x.PatternId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeId = table.Column<int>(type: "integer", nullable: false),
                    InputContent = table.Column<string>(type: "text", nullable: false),
                    Verdict = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    RiskScore = table.Column<byte>(type: "smallint", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AnalysisTypes",
                columns: new[] { "TypeId", "CreatedAt", "TypeName" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 6, 14, 43, 4, 190, DateTimeKind.Utc).AddTicks(3333), "Texto" },
                    { 2, new DateTime(2026, 6, 6, 14, 43, 4, 190, DateTimeKind.Utc).AddTicks(3341), "URL" },
                    { 3, new DateTime(2026, 6, 6, 14, 43, 4, 190, DateTimeKind.Utc).AddTicks(3344), "Imagen" }
                });
